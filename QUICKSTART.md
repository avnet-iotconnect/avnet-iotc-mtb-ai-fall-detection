...
* **Download** and **unzip** the pre-compiled [avnet-iotc-mtb-ai-fall-detection-INITIAL.zip](http://saleshosted.z13.web.core.windows.net/sdk/infineon/avnet-iotc-mtb-ai-fall-detection-INITIAL.zip) firmware package.
...
* Download the premade  [Device Template](files/psoc6airmfd-device-template.json?raw=1) (**must** Right-Click the link, Save As)
